...
// SUE + PABLO variant of the filler-expose page. Route /p/pablo.
//
...
export default function SuePabloAdvertorial() {
  ...
  useEffect(() => {
    ...
    document.title = "Pablo's story, Good For Pets";
    initTracking();
    track("ViewContent", { content_name: "Sue Pablo Advertorial", content_ids: ["5-strain-probiotic"], content_type: "product" });
