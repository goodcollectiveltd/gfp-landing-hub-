...
//
// Clones the exact structure of the live goodforpets.co/pages/10reasons page (author byline,
// top testimonial, 3-column SPRINKLE-vs-CHEWS comparison grid with the highlighted GFP column,
// TLDR, 10 numbered reasons, offer, reviews, stock warning, FAQ) but re-angled hard onto Will's
// filler-expose ad script: most chews are mostly glycerine/starch/grains/oils and the probiotics
// are an afterthought; the answer is a pure powder, 20x more good bacteria, 54% cheaper per serving,
// UK-vet formula, 51% to rescue, sold out every restock.
...
/* ---------- comparison grid (clones the live 10reasons 3-column table) ---------- */
...
export default function TenReasonsFillerAdvertorial() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ fontFamily: "'Inter', system-ui, sans-serif", color: INK, background: PAGE_BG }}>
      ...
      {/* comparison grid (the signature 10reasons element) */}
      ...
      {/* STOCK WARNING */}
      <section className="mx-auto mt-14 max-w-2xl px-6">
        <div className="rounded-3xl px-6 py-8 text-center text-white shadow-md" style={{ background: NAVY }}>
