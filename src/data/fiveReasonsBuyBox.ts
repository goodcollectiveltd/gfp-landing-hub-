// Exact live PDP buy box markup (GFP-Theme snippets/product-block-gfp-buy-box.liquid),
// with the real data pulled from the live product page. The theme script
// /lp/5reasons/bb/gfp-buy-box.js fills prices, supply-days, badges, the selling plan and
// the CTA price from the embedded data-gfp-bb-data JSON. Injected verbatim into /p/5reasons
// so the buy box is literally the live one (CSS: /lp/5reasons/bb/gfp-buy-box.css).
...
const size = (key: string, name: string, hint: string, checked: boolean) => `
  <label class="gfp-bb__size">
    ...
    <span class="gfp-bb__size-card">
      <span class="gfp-bb__size-icon gfp-bb__size-icon--${key}" style="--gfp-bb-dog: url('/lp/5reasons/bb/gfp-dog-${key}.png')" aria-hidden="true"></span>
...
export const BUYBOX_HTML = `
<div class="gfp-bb" data-gfp-buybox data-default-size="small" data-default-qty="2" data-default-subscribe="true">
  ...
  <fieldset class="gfp-bb__sizes">
    ...
    <div class="gfp-bb__size-row">
      ${size("small", "Small", "Up to 25kg", true)}
      ${size("medium", "Medium", "25–40kg", false)}
      ${size("large", "Large", "Over 40kg", false)}
    </div>
  </fieldset>
